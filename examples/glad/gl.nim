#[
    OpenGL loader generated by glad 0.1.10a0 on 04/01/16 19:11:47.
    ...
    Extensions:
        GL_EXT_separate_specular_color, GL_ARB_multisample
    Loader: No

    Commandline:
        --profile="compatibility" --api="gl=4.5" --generator="nim" --spec="gl" --no-loader --extensions="GL_EXT_separate_specular_color,GL_ARB_multisample"
    Online:
        http://glad.dav1d.de/#profile=compatibility&language=nim&specification=gl&api=gl%3D4.5&extensions=GL_EXT_separate_specular_color&extensions=GL_ARB_multisample
]#
...
var
  ...
  glDepthRange*: proc (near: GLdouble, far: GLdouble) {.cdecl.}
...
proc load_GL_VERSION_1_0(load: proc) =
  ...
  glDepthRange = cast[proc (near: GLdouble, far: GLdouble) {.cdecl.}](load("glDepthRange"))
