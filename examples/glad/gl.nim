#[
    OpenGL loader generated by glad 0.1.33 on Sun Nov 17 08:52:12 2019.
    ...
    Commandline:
        --profile="compatibility" --api="gl=4.5" --generator="nim" --spec="gl" --no-loader --extensions="GL_ARB_multisample,GL_EXT_separate_specular_color"
    Online:
        https://glad.dav1d.de/#profile=compatibility&language=nim&specification=gl&api=gl%3D4.5&extensions=GL_ARB_multisample&extensions=GL_EXT_separate_specular_color
]#
...
var
  ...
  glGetInternalformativ*: proc (target: GLenum, internalformat: GLenum, pname: GLenum, count: GLsizei, params: ptr GLint) {.cdecl.}
  ...
  glGetInternalformati64v*: proc (target: GLenum, internalformat: GLenum, pname: GLenum, count: GLsizei, params: ptr GLint64) {.cdecl.}
  ...
  glGetProgramResourceiv*: proc (program: GLuint, programInterface: GLenum, index: GLuint, propCount: GLsizei, props: ptr GLenum, count: GLsizei, length: ptr GLsizei, params: ptr GLint) {.cdecl.}
...
proc load_GL_VERSION_4_2(load: proc) =
  ...
  glGetInternalformativ = cast[proc (target: GLenum, internalformat: GLenum, pname: GLenum, count: GLsizei, params: ptr GLint) {.cdecl.}](load("glGetInternalformativ"))
...
proc load_GL_VERSION_4_3(load: proc) =
  ...
  glGetInternalformati64v = cast[proc (target: GLenum, internalformat: GLenum, pname: GLenum, count: GLsizei, params: ptr GLint64) {.cdecl.}](load("glGetInternalformati64v"))
  ...
  glGetProgramResourceiv = cast[proc (program: GLuint, programInterface: GLenum, index: GLuint, propCount: GLsizei, props: ptr GLenum, count: GLsizei, length: ptr GLsizei, params: ptr GLint) {.cdecl.}](load("glGetProgramResourceiv"))
